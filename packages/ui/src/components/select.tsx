...
>(({ children, className, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    {...props}
  >
    <span className="absolute right-2 flex size-3.5 items-center justify-center [&_svg:not([class*='size-'])]:size-4">
