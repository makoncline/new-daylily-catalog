...
- `apps/web/prisma/migrations/<timestamp>_<migration_name>/migration.sql`

Deterministic data SQL artifacts (generated by script):

- `apps/web/prisma/data-migrations/20260209_populate_cultivar_reference_from_ahs.sql`
- `apps/web/prisma/data-migrations/20260209_backfill_listing_cultivar_reference_id.sql`

Generator script:

- `apps/web/scripts/generate-cultivar-reference-data-sql.ts`
...
sqlite3 apps/web/prisma/local-prod-copy-daylily-catalog.db < apps/web/prisma/data-migrations/20260209_populate_cultivar_reference_from_ahs.sql
sqlite3 apps/web/prisma/local-prod-copy-daylily-catalog.db < apps/web/prisma/data-migrations/20260209_backfill_listing_cultivar_reference_id.sql
```
...
turso db shell daylily-catalog-stage < apps/web/prisma/data-migrations/20260209_populate_cultivar_reference_from_ahs.sql
turso db shell daylily-catalog-stage < apps/web/prisma/data-migrations/20260209_backfill_listing_cultivar_reference_id.sql
```
...
turso db shell daylily-catalog < apps/web/prisma/data-migrations/20260209_populate_cultivar_reference_from_ahs.sql
turso db shell daylily-catalog < apps/web/prisma/data-migrations/20260209_backfill_listing_cultivar_reference_id.sql
```
