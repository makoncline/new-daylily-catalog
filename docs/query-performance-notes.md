...
Do not commit raw profiler outputs (`apps/web/tests/.tmp/query-profiler/*`). Those are local artifacts.

## Run Snapshot

- Date: `2026-02-26`
- Scenario: strategic profiling e2e (`apps/web/tests/e2e/query-profiler-strategic.e2e.ts`)
- Reports:
  - `apps/web/tests/.tmp/query-profiler/e2e-strategic-report.json` (SQL)
  - `apps/web/tests/.tmp/query-profiler/e2e-strategic-report-operation.json` (operation)
- Totals:
