    ...
    const tools: WebMcpTool[] = [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            query: {
              type: "string",
              minLength: 1,
              description: "Cultivar name prefix, for example Coffee or Stella.",
            },
          },
        },
        annotations: {
        ...
        execute: async (input) => {
          ...
          const results = await client.dashboardDb.ahs.search.query({ query });
      ...
      },
      {
        ...
        inputSchema: {
          ...
          additionalProperties: false,
          properties: {
            title: { type: "string", description: "Garden or business name." },
            slug: { type: "string", description: "Optional public URL slug." },
            description: {
              type: ["string", "null"],
              description: "Short public catalog description. Use null to clear.",
            },
            location: {
              type: ["string", "null"],
        ...
        execute: async (input) => {
          ...
          queryClient.setQueryData([["dashboardDb", "userProfile", "get"], { type: "query" }], profile);
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            hidden: {
              type: "boolean",
              description: "Set true to keep the listing hidden from public pages.",
            },
          },
        },
        annotations: {
        ...
        execute: async (input) => {
          ...
          await updateListing({
            ...
            data: {
              ...
              status: input.hidden === undefined ? undefined : input.hidden ? "HIDDEN" : null,
            },
          });
      ...
      },
      {
        ...
        inputSchema: {
          type: "object",
          additionalProperties: false,
          required: ["type", "referenceId", "fileName", "contentType", "size"],
          properties: {
            type: { type: "string", enum: ["profile", "listing"] },
            referenceId: {
              type: "string",
              description: "Profile id or listing id that will own the image.",
            },
      ...
      },
      {
        ...
        execute: async (input) => {
          ...
          const list = await client.dashboardDb.list.get.query({ id: listId });
          return toolResult({ ok: true, list });
        },
      },
    ];
