...
const marketingPrimaryButton =
  `${marketingButtonBase} bg-[#ef533f] text-white hover:bg-[#d94734]`;
const marketingSecondaryButton =
  `${marketingButtonBase} border border-[#f4c477]/60 bg-transparent text-[#f4c477] transition-colors hover:bg-[#f4c477] hover:text-[#07120e]`;
        ...
        <div className="mx-auto grid max-w-[1024px] gap-8 lg:grid-cols-[0.48fr_1fr] lg:gap-14">
          <div className="lg:max-w-[31rem]">
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-[#536357]">
              Put your daylily listings, photos, prices, availability, notes,
              and contact info in one public catalog.
            </p>
          </div>
          ...
          <ul className="grid border-t border-[#d8dfd2] lg:grid-cols-2">
            {SELLER_BENEFITS.map((benefit) => (
              ...
              >
                <CheckCircle2 className="mt-1 h-5 w-5 shrink-0 text-[#a94e38]" />
        ...
        <div className="mx-auto max-w-[1024px]">
          ...
          <ol className="mt-10 grid list-none border-y border-white/20 lg:grid-cols-4">
            {HOW_IT_WORKS_STEPS.map((step, index) => (
              ...
              >
                <div
                  className="flex h-12 w-12 items-center justify-center bg-[#f4c477] text-base font-bold text-[#07120e]"
                  aria-hidden="true"
                >
                  {index + 1}
                </div>
        ...
        <div className="mx-auto max-w-[1024px]">
          <div className="grid gap-6 border-b border-[#d8dfd2] pb-8 lg:grid-cols-[0.72fr_1fr] lg:items-end">
            ...
            <p className="max-w-2xl text-lg leading-8 text-[#536357]">
              Your catalog can show buyers your profile, listings, photos,
              prices, availability, notes, and contact info.
            </p>
          </div>
