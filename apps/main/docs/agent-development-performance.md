...
| Unit suite                      | Local, 147 files and 513 tests         |    25.8s |
| Hermetic integration suite      | Local, 11 full-app browser flows       |    78.0s |
| Complete local E2E suite        | Local, 14 tests, one worker            | 2m 21.6s |
| Default agent verification      | Local, unit + static + integration     |   2m 03s |
...
| Related Vitest for leaf UI change           | 26.47s |                                 4.16s | Superseded locally: full suite is fast enough       |
| Agent checks with related tests             |  4.76s |                                 7.10s | Removed: default loop now runs complete suites      |
...
| Default full fast-test gate                 |      — |                                2m 03s | Keep: full Vitest and 11 integrations passed        |
