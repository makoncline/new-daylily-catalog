...
- [2026-07-15] Next/OG Sharp version alignment: Next 16.2.6 loads Sharp 0.34.5; keeping the app's direct Sharp dependency on 0.35.1 loads two libvips versions and can produce black or corrupt tiles in Satori OG renders. Pin the app to Sharp 0.34.5 while this Next version is installed, and verify `pnpm why sharp` shows one version before testing ImageAsset WebP normalization.
